...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GreenCoin Core greencoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  greencoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded greencoin transaction") + "\n" +
                               "  greencoin-tx [options] -create [commands]   " + _("Create hex-encoded greencoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded greencoin transaction
