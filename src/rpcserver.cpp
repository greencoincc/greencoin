...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GreenCoin features */
        {"greencoin", "masternode", &masternode, true, true, false},
        {"greencoin", "listmasternodes", &listmasternodes, true, true, false},
        {"greencoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"greencoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"greencoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"greencoin", "masternodedebug", &masternodedebug, true, true, false},
        {"greencoin", "startmasternode", &startmasternode, true, true, false},
        {"greencoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"greencoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"greencoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"greencoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"greencoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"greencoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"greencoin", "mnbudget", &mnbudget, true, true, false},
        {"greencoin", "preparebudget", &preparebudget, true, true, false},
        {"greencoin", "submitbudget", &submitbudget, true, true, false},
        {"greencoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"greencoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"greencoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"greencoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"greencoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"greencoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"greencoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"greencoin", "checkbudgets", &checkbudgets, true, true, false},
        {"greencoin", "mnsync", &mnsync, true, true, false},
        {"greencoin", "spork", &spork, true, true, false},
        {"greencoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"greencoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use greencoind, or the -server option to greencoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> greencoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37453/\n";
}
