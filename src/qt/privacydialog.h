...
public:
    ...
    void setZGreenCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzGRNC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzGRNC_clicked();
    void on_pushButtonZGreenCoinControl_clicked();
