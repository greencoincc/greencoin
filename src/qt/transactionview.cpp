                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received GreenCoin from zGreenCoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGreenCoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGreenCoin));
