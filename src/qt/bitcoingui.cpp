                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GRNC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GRNC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and greencoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGRNC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GRNC Core"), this);
    aboutAction->setStatusTip(tr("Show information about GRNC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GRNC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GRNC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GRNC addresses"));
    ...
    openAction->setStatusTip(tr("Open a GRNC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GRNC Core help message to get a list with possible GRNC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GRNC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GRNC network", "", count));
}
...
{
    QString strTitle = tr("GRNC Core"); // default title
