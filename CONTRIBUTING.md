Contributing to GRNC Core
============================

The GRNC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GRNC Core project, and is not to be
confused with overall GRNC Network Protocol consensus changes.

Whether a pull request is merged into GRNC Core rests with the project merge
...
Patches that change GRNC consensus rules are considerably more involved than
...
Where a patch set proposes to change the GRNC consensus, it must have been
...
The project leader is the release manager for each GRNC Core release.
