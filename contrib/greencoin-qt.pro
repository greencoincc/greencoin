...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/greencoin-cli.cpp \
           src/greencoin-tx.cpp \
           src/greencoin.cpp \
           src/db.cpp \
           ...
           src/qt/greencoin.cpp \
           src/qt/greencoinstrings.cpp \
...
RESOURCES += src/qt/greencoin.qrc src/qt/greencoin_locale.qrc

TRANSLATIONS += src/qt/locale/greencoin_bg.ts \
                src/qt/locale/greencoin_de.ts \
                src/qt/locale/greencoin_en.ts \
                src/qt/locale/greencoin_es.ts \
                src/qt/locale/greencoin_fi.ts \
                src/qt/locale/greencoin_fr.ts \
                src/qt/locale/greencoin_it.ts \
                src/qt/locale/greencoin_ja.ts \
                src/qt/locale/greencoin_pl.ts \
                src/qt/locale/greencoin_pt.ts \
                src/qt/locale/greencoin_ru.ts \
                src/qt/locale/greencoin_sk.ts \
                src/qt/locale/greencoin_sv.ts \
                src/qt/locale/greencoin_vi.ts \
                src/qt/locale/greencoin_zh_CN.ts \
                src/qt/locale/greencoin_zh_TW.ts
