...
This mechanism has been integrated into Bitcore-Node-GRNC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GRNC-Project/insight-api-greencoin#web-socket-api](https://github.com/GRNC-Project/insight-api-greencoin#web-socket-api) 
* API: [https://github.com/GRNC-Project/insight-api-greencoin#swifttx-transactions](https://github.com/GRNC-Project/insight-api-greencoin#swifttx-transactions) 
...
By default, the GRNC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GRNC Core daemon:
