...
#   c) node1 mines 32 blocks, so now node 0 has 60001greencoin, node 1 has 4250greencoin, node2 has none.
#   d) node0 sends 601 greencoin to node2, in two transactions (301 greencoin, then 300 greencoin).
